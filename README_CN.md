...
- 删除了对 `xorm.io/core` 的依赖。大部分代码迁移到了 `github.com/kkoudev/xorm/core`, `github.com/kkoudev/xorm/names`, `github.com/kkoudev/xorm/schemas` 等等几个包中.
...
* [Godoc代码文档](http://pkg.go.dev/github.com/kkoudev/xorm)
